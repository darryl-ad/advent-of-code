...
for idx_curr = 1:n_ranges 
    ingredient_ranges(idx_curr, :) = str2double( ...
        strsplit(ingredient_ranges_str(idx_curr), "-") ...
        );
end
...
for idx_curr = 2:n_ranges

    id_start = ingredient_ranges(idx_curr, 1);
    id_end = ingredient_ranges(idx_curr, 2);
